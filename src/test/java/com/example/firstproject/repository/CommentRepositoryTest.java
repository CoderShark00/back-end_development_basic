...
class CommentRepositoryTest {
    ...
    void findByArticleId() {
        ...
        /* Case 4: 999번 게시글의 모든 댓글 조회 */
        {
            ...
            List<Comment> expected = Arrays.asList();
            // 4. 비교 및 검증
            assertEquals(expected.toString(),comments.toString(),"999번 게시글 없음");
        }
        /* Case 5: -1번 게시글의 모든 댓글 조회 */
        {
            ...
            List<Comment> expected = Arrays.asList();
            // 4. 비교 및 검증
            assertEquals(expected.toString(), comments.toString(),"-1번글 없음");
        }
    }
    ...
    void findByNickname(){
        ...
        /* Case 4: ""의 모든 댓글 조회 */
        {
            ...
            List<Comment> expected = Arrays.asList();
            // 4. 비교 및 검증
            assertEquals(expected.toString(),comments.toString(),"없음");
        }
    }
}